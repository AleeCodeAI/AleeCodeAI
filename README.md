...
An AI-powered email automation system that intelligently manages inbox overload, saving hours of time.

**Key Features:**
- Automated email processing backend
- Streamlit frontend for manual oversight & analytics
- Secure API server for database operations
- Real-time analytics dashboard

**[Watch Demo](https://drive.google.com/file/d/1jhVm51-drzOTcm3QLk6DfrgbH1j9kRO6/view?usp=sharing)** | **[View Repository](https://github.com/AleeCodeAI/Intelligent_Inbox_Manager)**
